...
# ------------------------------------------------------------------
# Монкепатч: если в текущей версии Python нет inspect.getargspec,
# создаём совместимую обёртку через getfullargspec.
# ------------------------------------------------------------------
...
SIMILARITY_THRESHOLD = 0.7  # Порог схожести для включения в результаты
MAX_MATCHES = 3  # Максимальное количество совпадений
...
for i, row in df_ok.iterrows():
    ...
    combined_scores = 0.75 * sem_scores + 0.25 * tfidf_scores
